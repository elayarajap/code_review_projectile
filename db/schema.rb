...
ActiveRecord::Schema.define(:version => 20160301101311) do
  ...
  add_index "action_items", ["meeting_id"], :name => "index_action_items_on_meeting_id"
  ...
  create_table "consolidated_reports", :force => true do |t|
    t.integer  "user_id"
    t.integer  "group_id"
    t.string   "group_name"
  ...
  create_table "custom_attendees", :force => true do |t|
    t.string   "name"
    t.string   "email"
    t.integer  "meeting_id"
    t.datetime "created_at", :null => false
  ...
  create_table "issues", :force => true do |t|
    ...
    t.float    "billable",         :default => 0.0,   :null => false
    t.float    "non_billable",     :default => 0.0,   :null => false
  end

  add_index "issues", ["assigned_to_id"], :name => "index_issues_on_assigned_to_id"
  add_index "issues", ["author_id"], :name => "index_issues_on_author_id"
  add_index "issues", ["billable"], :name => "index_issues_on_billable"
  ...
  add_index "issues", ["non_billable"], :name => "index_issues_on_non_billable"
  ...
  create_table "projects", :force => true do |t|
    ...
    t.string   "group_mail_address"
    t.string   "project_type"
    t.string   "project_method"
  ...
  create_table "time_entries", :force => true do |t|
    ...
    t.float    "non_billable",        :default => 0.0,   :null => false
    t.integer  "group_id"
    t.boolean  "hours_type",          :default => false
