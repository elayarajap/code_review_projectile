  ...
  def custom_field_tag(name, custom_value)
    ...
    when "list"
      ...
      if custom_field.name == "Severity"
        blank_option = ''.html_safe
        s = select_tag(field_name, blank_option + options_for_select([["0 - Critical",0],["1 - Functional Failure",1],["2 - Functional Workaround",2],["3 - User Interface",3],["4 - Comments /Suggestions ",4]]),
          tag_options)
       else
