...
class CustomField < ActiveRecord::Base
  ...
  attr_accessible :type,:name,:field_format,:possible_values,:regexp,:min_length,:max_length,:is_required,:is_for_all,:is_filter,:position,:searchable,:default_value,:editable,:visible,:multiple
